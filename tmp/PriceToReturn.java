...
class PriceToReturn{  
	  ...
	  public static void main(String[] args){
		   ...
		   try {
	         ...
	         while (( tmpLine = input.readLine()) != null){
	         	     inputData="c:\\java\\TWStocks\\output\\"+tmpLine+".csv";
	         	     outputData="c:\\java\\TWStocks\\data\\"+tmpLine+"_R.csv";      
    ...
    public static void csvCalcReturn(String csv_in, String csv_out) {
				...
				String csv_Index = "c:\\java\\TWStocks\\data\\TW.csv";
    ...
    ***********************************************************************/    
    ...
    /********************************************************************
      Sub-Function for computing AR by Returns
    ***********************************************************************/
    /*
    public static double [] calcABReturn(double stock_return[], double market_return[],
				      ...
				      double curr_market_return, double curr_riskfree_rate) {
							...
							finalResult[0]= ab_return;
							finalResult[1]= a;
							finalResult[2]= b;
							finalResult[3]= reg.getSSR()/(reg.getSSR()+reg.getSSE());;
